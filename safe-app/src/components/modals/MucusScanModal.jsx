          ...
          if (l <= 25) {
            ...
            if (stdDevL > 18) {
              ...
              if (questionnaireData) {
                 ...
                 // Thicker/discolored mucus often associated with stronger symptoms
              ...
              if (clearScore > whiteScore) {
                ...
                matched = MUCUS_COLORS.find(c => c.id === 'white'); // Default fallback
              }
            }
          } else {
          ...
          try {
            ...
            for (let y = centerStart; y < centerEnd; y++) {
              for (let x = centerStart; x < centerEnd; x++) {
                ...
                const max = Math.max(normR, normG, normB);
                const min = Math.min(normR, normG, normB);
                const pixelL = (max + min) / 2 * 100;
                
                lightnessPixels.push(pixelL);
                pixelCount++;
              }
            }
            ...
            if (l <= 25) {
              ...
              if (stdDevL > 18) {
                ...
                // Tie-breaker using userSelectedColor if available
                if (userSelectedColor && (userSelectedColor.id === 'clear' || userSelectedColor.id === 'white')) {
                  ...
                  matched = MUCUS_COLORS.find(c => c.id === 'white'); // Default
                }
              }
            } else {
              for (const mc of MUCUS_COLORS) {
